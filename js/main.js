...
(function(html) {
    ...
    * ------------------------------------------------------ */
    ...
    const devIcons = document.querySelectorAll('.mob-techstack i');
    ...
    devIcons.forEach(i => i.addEventListener('mouseover', getClicked));
    devIcons.forEach(i => i.addEventListener('mouseout', offClicked));

    // const windowSize = window.innerWidth;
    // const lengthIcons = devIcons.length;
    // if((windowSize >= 820)&&(is_touch_device()))
    //     for (let i = 0; i < lengthIcons; i++) {
    //         devIcons[i].className = devIcons[i].className + " colored";
    //     }
